...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 px-0 pt-4 pb-2">
      <div className="mx-auto flex w-[min(var(--max-width),calc(100%-2rem))] items-center justify-between gap-4 rounded-[28px] border border-white/75 bg-[linear-gradient(180deg,rgba(255,255,255,0.72),rgba(255,245,238,0.68))] px-4 py-3 shadow-[0_18px_44px_rgba(31,41,55,0.07)] backdrop-blur-[24px] max-[900px]:w-[min(var(--max-width),calc(100%-1.25rem))]">
