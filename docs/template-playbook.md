...
Reusable playbook for building a serious starter repo, even when the product domain changes. Adapt the governance recommendations to the repository's visibility and ownership model.
